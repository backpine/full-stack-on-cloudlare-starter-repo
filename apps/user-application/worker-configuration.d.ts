/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface Env --env production` (hash: ed829be19efe9bd6ed0aee5e6a2a63a9)
...
declare namespace Cloudflare {
	interface Env {
		...
		DB: D1Database;
		BACKEND_SERVICE: Fetcher /* data-service-production */;
		ASSETS: Fetcher;
	}
}
